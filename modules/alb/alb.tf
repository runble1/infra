...
resource "aws_security_group" "alb25" {
  name   = "${var.env}-${var.service}-alb25-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
...
resource "aws_security_group" "alb26" {
  name   = "${var.env}-${var.service}-alb26-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
...
resource "aws_security_group" "alb27" {
  name   = "${var.env}-${var.service}-alb27-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
...
resource "aws_security_group" "alb28" {
  name   = "${var.env}-${var.service}-alb28-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
...
resource "aws_security_group" "alb29" {
  name   = "${var.env}-${var.service}-alb29-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
...
resource "aws_security_group" "alb30" {
  name   = "${var.env}-${var.service}-alb30-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
...
resource "aws_security_group" "alb33" {
  name   = "${var.env}-${var.service}-alb33-sg"
  vpc_id = var.vpc_id
  egress {
    from_port   = 0
    to_port     = 0
